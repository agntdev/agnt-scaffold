...
async function helpText(ctx: Ctx) { return tr(await locale(ctx), "help", "Open the menu with /start, then choose a project, revision, or code snippet. You’ll answer one clear question at a time. Use /language to choose English or Hinglish."); }
